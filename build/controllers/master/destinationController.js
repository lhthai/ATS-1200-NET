...
function () {
  ...
  _regenerator["default"].mark(function _callee(req, res) {
    var _req$body, code, name, temp, destination, newDestination;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return _destinationMaster["default"].findOne({
              code: code
            });
          ...
          case 8:
            _context.prev = 8;
            destination = new _destinationMaster["default"]({
              code: code,
              name: name
            });
            _context.next = 12;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _destinationMaster["default"].find({});
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return _destinationMaster["default"].findByIdAndRemove({
              _id: req.params.id
            });
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.next = 5;
            return _destinationMaster["default"].findOneAndUpdate({
              _id: req.params.id
            }, item, {
              "new": true
            });
